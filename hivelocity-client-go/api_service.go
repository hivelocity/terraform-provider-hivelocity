...
func (a *ServiceApiService) GetServiceIdResource(ctx context.Context, serviceId int32, localVarOptionals *ServiceApiGetServiceIdResourceOpts) (ServiceDump, *http.Response, error) {
	var (
...
func (a *ServiceApiService) GetServiceResource(ctx context.Context, status string, localVarOptionals *ServiceApiGetServiceResourceOpts) ([]ServiceDump, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
